...
module.exports = class Venture{
  ...
  static async create({ ventureID, ventureTitle, firstName, hostEmail, ventureName }){
    ...
    (venture_id, venture_title, venture_name, host_email, host_fname, chat, participants )
    VALUES ($1, $2, $3, $4, $5, $6, $7 )
    RETURNING *
    
    `, [ventureID, ventureTitle, ventureName, hostEmail, firstName, '[]', participants]);
